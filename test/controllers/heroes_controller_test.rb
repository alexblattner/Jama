...
class HeroesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hero" do
    assert_difference('Hero.count') do
      post heroes_url, params: { hero: { hero_exp: @hero.hero_exp, hero_hp: @hero.hero_hp, name: @hero.name } }
    end
  ...
  test "should update hero" do
    patch hero_url(@hero), params: { hero: { hero_exp: @hero.hero_exp, hero_hp: @hero.hero_hp, name: @hero.name } }
